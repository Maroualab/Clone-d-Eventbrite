...
<body>
      ...
      <div class="widget">
        <div class="vs-widget-about">
          <div class="footer-logo">
            <a href="index.html"><img src="../../../public/assets/img/logo.svg" alt="Eventino"></a>
          </div>
          <p>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between gy-1 text-center text-lg-start">
          <div class="col-lg-auto d-none d-lg-block">
            <p class="header-text"><i class="fas fa-map-marker-alt"></i>12/7 new town, 245x Town 1214 Street, United State
            </p>
          </div>
                    ...
                    <div class="d-none d-lg-block">
                      <form action="#" class="header-search v3">
                        ...
                        <button type="submit" aria-label="button">
                          <img src="../../../public/assets/img/icons/e-2-2.svg" alt="icon">
                        </button>
                      </form>
                    </div>
  ...
  <section>
    <div class="vs-carousel style1" data-autoplay="false" data-slide-show="1" data-fade="true" data-arrows="false">
            ...
            <div class="row justify-content-between">
              ...
              <div class="col-lg-5">
                <form class="form-style1 ajax-contact" action="mail.php" method="post">
                  <img src="../../../public/assets/img/shapes/f-1-1.png" alt="form shape" class="shape-1">
                  <img src="../../../public/assets/img/shapes/f-1-2.png" alt="form shape" class="shape-2">
      ...
      <div>
        <div class="hero-inner">
          <div class="overlay"></div>
          <div class="hero-bg" data-bg-src="../../../public/assets/img/bg/h-1-3.jpg"></div>
          <div class="container">
            <div class="row justify-content-between">
              <div class="col-lg-6">
                <div class="hero-content">
  ...
  <!-- About Area End -->
  <!-- Counter Area Start -->
  <div class="position-relative counter-area1">
  ...
  <section class="service smoke-bg space">
    <div class="container">
      ...
      <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" id="service-slider1">
        <div class="col-lg-3">
  ...
  <section class="events space-top space-extra-bottom">
    <div class="container">
      ...
      <div class="row filter-active2 wow fadeInUp" data-wow-delay="0.4s">
        ...
        <div class="col-md-6 col-lg-4 filter-item Education Sport Art">
          <div class="event-style1">
            <div class="event-img">
        ...
        <div class="col-md-6 col-lg-4 filter-item Art Education More">
          <div class="event-style1">
            <div class="event-img">
        ...
        <div class="col-md-6 col-lg-4 filter-item Education Business Education">
          <div class="event-style1">
            <div class="event-img">
        ...
        <div class="col-md-6 col-lg-4 filter-item Business Sport More">
          <div class="event-style1">
            <div class="event-img">
        ...
        <div class="col-md-6 col-lg-4 filter-item Sport Festival">
          <div class="event-style1">
            <div class="event-img">
  ...
  <section class="feature-layout1">
    <div class="overlay"></div>
    <img src="../../../public/assets/img/bg/f-o-1-1.png" alt="img overlay" class="img-overlay">
    <div class="container">
      <div class="row justify-content-between align-items-end">
        <div class="col-lg-6">
          <div class="title-area">
      ...
      <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" id="service-slider2">
        <div class="col-lg-3">
          <div class="feature-style1">
            <div class="feature-icon">
              <img src="../../../public/assets/img/icons/f-1-1.svg" alt="feature icon 1">
            </div>
        ...
        <div class="col-lg-3">
          <div class="feature-style1">
            <div class="feature-icon">
              <img src="../../../public/assets/img/icons/f-1-2.svg" alt="feature icon 1">
            </div>
        ...
        <div class="col-lg-3">
          <div class="feature-style1">
            <div class="feature-icon">
              <img src="../../../public/assets/img/icons/f-1-3.svg" alt="feature icon 1">
            </div>
        ...
        <div class="col-lg-3">
          <div class="feature-style1">
            <div class="feature-icon">
              <img src="../../../public/assets/img/icons/f-1-5.svg" alt="feature icon 1">
            </div>
        ...
        <div class="col-lg-3">
          <div class="feature-style1">
            <div class="feature-icon">
              <img src="../../../public/assets/img/icons/f-1-4.svg" alt="feature icon 1">
            </div>
  ...
  <section class="smoke-bg">
    <div class="container">
      <div class="video-wrap1" data-bg-src="../../../public/assets/img/bg/video-bg-1-1.jpg">
        <div class="overlay"></div>
        <div class="row">
          <div class="col-lg-7">
            <a href="https://www.youtube.com/watch?v=ng9g_mtSfQc" class="play-btn popup-video" tabindex="0"><i
              class="fas fa-play"></i></a>
            <span class="sec-subtitle4">See And Descover</span>
            <h2 class="sec-title mb-0 text-white ">Know More About Eventino For Better Experience</h2>
          </div>
        </div>
      </div>
    </div>
    <div class="space">
      <div class="container">
        <div class="position-relative">
          <button class="vs-btn prev slidebtn1 d-none d-md-block" data-slick-prev="#brand-slider1">
            <i class="far fa-arrow-left"></i>
          </button>
          <div class="vs-carousel brand-wrap1" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" id="brand-slider1">
            <div>
              <div class="brand-style1">
                <img src="../../../public/assets/img/brand/b-1-1.svg" alt="brand">
              </div>
            </div>
            <div>
              <div class="brand-style1">
                <img src="../../../public/assets/img/brand/b-1-2.svg" alt="brand">
              </div>
            </div>
            <div>
              <div class="brand-style1">
                <img src="../../../public/assets/img/brand/b-1-3.svg" alt="brand">
              </div>
            </div>
            <div>
              <div class="brand-style1">
                <img src="../../../public/assets/img/brand/b-1-4.svg" alt="brand">
              </div>
            </div>
            <div>
              <div class="brand-style1">
                <img src="../../../public/assets/img/brand/b-1-5.svg" alt="brand">
              </div>
            </div>
          </div>
          <button class="vs-btn next slidebtn1 d-none d-md-block" data-slick-next="#brand-slider1">
            <i class="far fa-arrow-right"></i>
          </button>
        </div>
      </div>
      ...
      <div class="row gx-30 filter-active filter-gallery">
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-1.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-1.jpg" alt="gallery">
            </div>
        ...
        <div class="col-lg-6 col-md-6 filter-item grid-item--width2">
          <div class="gallery-style1">
            ...
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-2.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-3.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-3.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-6 col-md-6 filter-item grid-item--width2">
          <div class="gallery-style1">
            ...
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-4.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-5.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-5.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-6.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-6.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-7.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-7.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-3 col-md-6 filter-item">
          <div class="gallery-style1">
            <a href="../../../public/assets/img/gallery/g-1-8.jpg" class="popup-image popup-link">
              <i class="fas fa-image"></i>
            </a>
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-8.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
        ...
        <div class="col-lg-6 col-md-6 filter-item grid-item--width2">
          <div class="gallery-style1">
            ...
            <div class="overlay"></div>
            <div class="gallery-thumb">
              <img src="../../../public/assets/img/gallery/g-1-9.jpg" alt="gallery">
            </div>
            <div class="gallery-content">
              <div class="gallery-date">
                <span>
    ...
    <div class="container">
      ...
      <div class="test-wrap1">
        ...
        <div class="testi-thumb">
          <img src="../../../public/assets/img/testimonials/testi-thumb-1.jpg" alt="testi thumb 1">
        </div>
        <div class="vs-carousel row" data-slide-show="2" data-lg-slide-show="2" data-md-slide-show="1" id="testi-slider1">
          <div class="col-auto">
            <div class="testi-style1">
              <div class="testi-icon">
                <img src="../../../public/assets/img/icons/t-1-1.svg" alt="testi icon">
              </div>
              <div class="testi-author">
                <div class="author-img"><img src="../../../public/assets/img/user/user-img-1-1.jpg" alt="Testimonial"></div>
                <div class="media-body">
          ...
          <div class="col-auto">
            <div class="testi-style1">
              ...
              <div class="testi-author">
                <div class="author-img"><img src="../../../public/assets/img/user/user-img-1-2.jpg" alt="Testimonial"></div>
                <div class="media-body">
          ...
          <div class="col-auto">
            <div class="testi-style1">
              ...
              <div class="testi-author">
                <div class="author-img"><img src="../../../public/assets/img/user/user-img-1-3.jpg" alt="Testimonial"></div>
                <div class="media-body">
  ...
  <div class="newsletter-layout1">
    ...
    <div class="container">
      <form action="mail.php" class="newsletter-form1">
        <img src="../../../public/assets/img/shapes/ns-1-1.png" alt="shape" class="shape position-absolute top-0 start-0">
        <img src="../../../public/assets/img/shapes/ns-1-2.png" alt="shape" class="shape position-absolute bottom-0 end-0">
        <div class="row g-4 justify-content-between align-items-center">
          <div class="col-xl-4 col-lg-6">
            <h2 class="sec-title text-white mb-0">Get A New Experience With</h2>
          </div>
          <div class="col-lg-auto">
            <div class="row gx-3">
              <div class="col-auto flex-grow-1 mb-0">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 col-lg-4 col-xl-auto">
            <div class="widget footer-widget">
              <h3 class="widget_title">About Company<img src="../../../public/assets/img/shapes/d-1-1.svg"></h3>
              <div class="footer-logo">
                <a href="index.html"><img src="../../../public/assets/img/logo-white.svg" alt="Eventino" class="logo"></a>
              </div>
              <div class="vs-widget-about">
                <p class="footer-text">Vestibulum ac diam sit amet quam vehicula on the elementum sed amet
                  dui molestie
          ...
          <div class="col-md-6 col-lg-2 col-xl-auto">
            <div class="widget widget_nav_menu footer-widget">
              <h3 class="widget_title">Quick Link<img src="../../../public/assets/img/shapes/d-1-1.svg"></h3>
          ...
          <div class="col-md-6 col-lg-2 col-xl-auto">
            <div class="widget widget_nav_menu footer-widget">
              <h3 class="widget_title">Explore<img src="../../../public/assets/img/shapes/d-1-1.svg"></h3>
              <div class="menu-all-pages-container">
                <ul class="menu">
          ...
          <div class="col-md-6 col-xl-auto">
            <div class="widget footer-widget">
              ...
              <div class="sidebar-gallery">
                ...
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/widget/gal-1-2.jpg" alt="Gallery Image" class="w-100">
                </div>
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/widget/gal-1-3.jpg" alt="Gallery Image" class="w-100">
                </div>
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/widget/gal-1-4.jpg" alt="Gallery Image" class="w-100">
                </div>
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/widget/gal-1-5.jpg" alt="Gallery Image" class="w-100">
                </div>
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/widget/gal-1-6.jpg" alt="Gallery Image" class="w-100">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row g-4 align-items-center justify-content-between">
          ...
          <div class="col-xl-auto col-lg-7">
            <div class="footer-info">
              ...
              <div class="media-body">
                <span class="footer-info_label">Our Office Address</span>
                <div class="footer-info_link">
                  12/7 new town, 245x Town 1214 Street, US
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-auto col-lg-5">
            <div class="footer-info">
              ...
              <div class="media-body">
                <span class="footer-info_label">Call Us 27/7</span>
                <div class="footer-info_link">
                  <a href="tel:+9885643210980">+988 564 (3210) 980</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="copyright-wrap">
        <div class="row justify-content-center justify-content-lg-between">
          <div class="col-auto">
            <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2024 <a href="index.html">Eventino</a>. All
