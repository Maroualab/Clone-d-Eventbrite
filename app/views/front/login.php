      ...
      <div class="widget">
        ...
        <div class="recent-post-wrap">
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="../../../public/assets/img/blog/recent-post-1-1.jpg"
                  alt="Blog Image"></a>
            </div>
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="../../../public/assets/img/blog/recent-post-1-2.jpg"
                  alt="Blog Image"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="../../../public/assets/img/blog/recent-post-1-3.jpg"
                  alt="Blog Image"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="../../../public/assets/img/blog/recent-post-1-4.jpg"
                  alt="Blog Image"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
          ...
          <div class="row gx-50 justify-content-between align-items-center gx-sm-0">
            <div class="col">
              <div class="header-logo">
                <a href="index.html"><img src="../../../public/assets/img/logo.svg" alt="Eventino" class="logo"
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                  type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Register</button>
              </li>
            </ul>
            <div class="auth-social">
              <h5 class="auth-title">Log In Directly With</h5>
              <div class="footer-social style3" style="display: flex
              ;
                ...
                <a href="https://www.google.com/" style="display: flex
                ;
                    justify-content: center;
                    align-items: center;
                    "><i class="fab fa-google"></i></a>
                <a href="https://www.gmail.com/" style="display: flex
                ;
                    justify-content: center;
                    align-items: center;
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <form class="auth-form" action="/login" method="post">
                  ...
                  <!-- Submit Button -->
                  <div class="d-flex">
                    <button type="submit" class="vs-btn w-100">Log In</button>
                  </div>

                  <!-- Register Link -->
                  <p class="auth-link">Not a Member? <a href="/register">Register</a></p>
                </form>
              ...
              <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                ...
                <form class="auth-form style2" action="/register" method="post" enctype="multipart/form-data">
                  <!-- Full Name -->
                  <div class="form-group">
                  ...
                  <!-- Avatar -->
                  <div class="form-group">
                    <label class="auth-label" for="avatar">Avatar</label>
                    <div>
                  ...
                  <!-- Register Button -->
                  <div class="d-flex">
                    <button type="submit" class="vs-btn w-100">Register</button>
                  </div>
  ...
  <div class="newsletter-layout1">
    ...
    <div class="container">
      <form action="mail.php" class="newsletter-form1">
        <img src="../../../public/assets/img/shapes/ns-1-1.png" alt="shape"
          class="shape position-absolute top-0 start-0">
        <img src="../../../public/assets/img/shapes/ns-1-2.png" alt="shape"
          class="shape position-absolute bottom-0 end-0">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 col-lg-4 col-xl-auto">
            <div class="widget footer-widget">
              ...
              <div class="footer-logo">
                <a href="index.html"><img src="../../../public/assets/img/logo-white.svg" alt="Eventino"
                    class="logo"></a>
              </div>
              <div class="vs-widget-about">
