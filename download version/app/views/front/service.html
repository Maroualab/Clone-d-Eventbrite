...
<body>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-30">
          <div class="service-style1">
            ...
            <div class="service-img">
              <img src="../../../public/assets/img/services/s-1-6.jpg" alt="service image">
            </div>
            <div class="service-content">
              <h2 class="service-name"><a href="service-details.html">Birthday Party</a></h2>
              <span class="service-price">Start from <span>$1.400-$2.000</span></span>
        ...
        <div class="col-lg-3 col-md-6 mb-30">
          <div class="service-style1">
            ...
            <div class="service-img">
              <img src="../../../public/assets/img/services/s-1-7.jpg" alt="service image">
            </div>
            <div class="service-content">
              <h2 class="service-name"><a href="service-details.html">Wedding Party</a></h2>
              <span class="service-price">Start from <span>$1.400-$2.000</span></span>
        ...
        <div class="col-lg-3 col-md-6 mb-30">
          <div class="service-style1">
            ...
            <div class="service-img">
              <img src="../../../public/assets/img/services/s-1-8.jpg" alt="service image">
            </div>
            <div class="service-content">
              <h2 class="service-name"><a href="service-details.html">Office Party</a></h2>
              <span class="service-price">Start from <span>$1.400-$2.000</span></span>
  ...
  <!-- Service Area End -->
  <!-- Upcoming Events -->
  <section class="events-layout3 space smoke-bg">
    <div class="container">
      <div class="row">
  ...
  <!-- Feature Area End -->
  <!-- Testimonial Area -->
  <section class="smoke-bg space-top space-bottom">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 mx-auto">
          <div class="title-area text-center">
