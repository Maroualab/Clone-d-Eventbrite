...
<body>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between gy-1 text-center text-lg-start">
          <div class="col-lg-auto d-none d-lg-block">
            <p class="header-text"><i class="fas fa-map-marker-alt"></i>12/7 new town, 245x Town 1214 Street,
              United State
            </p>
          </div>
                    ...
                    <div class="d-none d-lg-block">
                      <form action="#" class="header-search v2">
                        ...
                        <button type="submit" aria-label="search-button">
                          <img src="../../../public/assets/img/icons/e-2-1.svg" alt="icon">
                        </button>
                      </form>
                    </div>
  ...
  <!--==============================
    Breadcumb
    ============================== -->
  <div class="breadcumb-wrapper" data-bg-src="../../../public/assets/img/bg/breadcumb-bg.jpg">
    <div class="overlay"></div>
    <img src="../../../public/assets/img/shapes/b-1-1.png" alt="shape" class="shape">
    <div class="container z-index-common">
      <div class="breadcumb-content">
        <h1 class="breadcumb-title">Happy New Year Reunion And Music Festible</h1>
  ...
  <div class="space-top space-extra-bottom">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <img src="../../../public/assets/img/events/e-d-1-1.jpg" alt="Event Details" class="event-details-img mb-50">
          <div class="row gx-10">
            <div class="col-md-4 mb-30">
              <div class="item-card">
                ...
                <div class="item-content">
                  ...
                  <span class="item-text">28 January, 2023</span>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-30">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non nulla sit amet nisl tempus convallis
            quis ac lectus. Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Donec rutrum congue leo
            eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Vestibulum ac diam sit amet quam
          ...
          <div class="row">
            <div class="col-md-6">
              <img src="../../../public/assets/img/events/e-d-1-2.jpg" alt="Event Details" class="event-details-img2 mb-30">
            </div>
            <div class="col-md-6">
              <img src="../../../public/assets/img/events/e-d-1-3.jpg" alt="Event Details" class="event-details-img2 mb-30">
            </div>
          </div>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non nulla sit amet nisl tempus convallis
            quis ac lectus. Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Donec rutrum congue leo
            ...
            <div class="row justify-content-between align-items-center">
              <div class="col">
                <div class="post-pagi-box prev">
                  <a href="blog-details.html"><img src="../../../public/assets/img/events/e-d-1-4.jpg" alt="pagi"></a>
              ...
              <div class="col">
                <div class="post-pagi-box next">
                  <a href="blog-details.html"><img src="../../../public/assets/img/events/e-d-1-5.jpg" alt="pagi"></a>
          ...
          <div class="row">
            <div class="col-lg-7">
              ...
              <p>Cras semper, massa vel aliquam luctus, eros odio tempor turpis, ac placerat metus tortor eget magna.</p>
            </div>
            <div class="col-md-6">
              <div class="gallery-style1">
                ...
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/gallery/g-4-1.jpg" alt="gallery">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="gallery-style1">
                ...
                <div class="overlay"></div>
                <div class="gallery-thumb">
                  <img src="../../../public/assets/img/gallery/g-4-2.jpg" alt="gallery">
                </div>
              </div>
              <div class="gallery-style1">
                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video popup-link">
          ...
          <div class="vs-comments-wrap">
            ...
            <ul class="comment-list">
              <li class="vs-comment-item">
                <div class="vs-post-comment">
                  <div class="comment-avater">
                    <img src="../../../public/assets/img/users/user-1-1.jpg" alt="Comment Author">
                  </div>
                  <div class="comment-content">
                    <span class="commented-on">28 Jan, 2023</span>
                    <h4 class="name h4">David Warnner</h4>
                    <p class="text">Collaboratively empower multifunctional e-commerce for prospective applications.
                ...
                <ul class="children">
                  <li class="vs-comment-item">
                    <div class="vs-post-comment">
                      <div class="comment-avater">
                        <img src="../../../public/assets/img/users/user-1-2.jpg" alt="Comment Author">
                      </div>
                      <div class="comment-content">
                        <span class="commented-on">28 Jan, 2023</span>
              ...
              <li class="vs-comment-item">
                <div class="vs-post-comment">
                  <div class="comment-avater">
                    <img src="../../../public/assets/img/users/user-1-3.jpg" alt="Comment Author">
                  </div>
                  <div class="comment-content">
                    <span class="commented-on">28 Jan, 2023</span>
                    <h4 class="name h4">David Warnner</h4>
            ...
            <div class="widget">
              ...
              <div class="sidebar-brand">
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-2.png" alt="brand">
                </div>
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-3.png" alt="brand">
                </div>
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-4.png" alt="brand">
                </div>
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-5.png" alt="brand">
                </div>
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-6.png" alt="brand">
                </div>
                <div class="brand-logo">
                  <img src="../../../public/assets/img/brand/sidebar-brand-1-7.png" alt="brand">
                </div>
              </div>
            </div>
          </div>
